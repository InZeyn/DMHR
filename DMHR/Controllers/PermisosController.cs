...
namespace DMHR.Controllers
{
    public class PermisosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PermisoId,Desde,Hasta,Comentarios,IsPaid,EmpleadoId")] Permiso permiso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PermisoId,Desde,Hasta,Comentarios,IsPaid,EmpleadoId")] Permiso permiso)
        {
