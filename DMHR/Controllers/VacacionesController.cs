...
namespace DMHR.Controllers
{
    public class VacacionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VacacionId,Desde,Hasta,Date,Comentarios,IsPaid,EmpleadoId")] Vacacion vacacion)
        {
            ...
            ViewData["EmpleadoId"] = new SelectList(_context.Empleados, "EmpleadoId", "Apellido", vacacion.EmpleadoId);
            return View(vacacion);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VacacionId,Desde,Hasta,Date,Comentarios,IsPaid,EmpleadoId")] Vacacion vacacion)
        {
