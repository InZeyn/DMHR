...
namespace DMHR.Controllers
{
    public class CargosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CargoId,CargoNombre")] Cargo cargo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CargoId,CargoNombre")] Cargo cargo)
        {
            if (id != cargo.CargoId)
            {
                return NotFound();
